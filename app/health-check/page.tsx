  ...
  if (selectedMetric) {
    ...
    return (
      <div style={{ minHeight: "100vh", backgroundColor: "#1a1a1a", color: "#e0e0e0" }}>
        ...
        {/* Main Content */}
        <div style={{ padding: "100px 50px 50px 50px", maxWidth: "600px", margin: "0 auto" }}>
          <button
          ...
          <div style={{ textAlign: "center" }}>
            <MetricCard title={metric?.title || ""} score={metric?.score || 0} />
            ...
            >
              Detailed health analysis coming soon...
            </div>
          </div>
        </div>
      </div>
